...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, SR_SRCLK_Pin|COIL_A_Pin|LCD_RW_Pin|COIL_C_Pin
  ...
  /*Configure GPIO pins : SR_SRCLK_Pin COIL_A_Pin LCD_RW_Pin COIL_C_Pin
                           LCD_D4_Pin LCD_D5_Pin LCD_D6_Pin LCD_D7_Pin */
  GPIO_InitStruct.Pin = SR_SRCLK_Pin|COIL_A_Pin|LCD_RW_Pin|COIL_C_Pin
                          |LCD_D4_Pin|LCD_D5_Pin|LCD_D6_Pin|LCD_D7_Pin;
